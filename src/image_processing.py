...
Please format the output as a JSON object, following this structure exactly:
{
    ...
    "About Deceased Person" : {
        ...
        "City of death" : ,
        "Family member name" : (hints :  fils/ fille/ père/ mère/ frère/ sœur/ cousin/ cousine/ neveu/ nièce/ oncle/ tante/ Epoux/ Epouse/ etc...),
        "Family Address" : full address,
        "Relation with Deceased person" : (fils/ fille/ père/ mère/ frère/ sœur/ cousin/ cousine/ neveu/ nièce/ oncle/ tante/ Epoux/ Epouse/ etc...)
    }
}
""")
