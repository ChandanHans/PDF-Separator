...
Please format the output as a JSON object, following this structure exactly:
{
    ...
    "About Deceased Person" : {
        ...
        "City of death" : ,
        "Family member name" : (from delaration section) (hints :  fils/ fille/ père/ mère/ frère/ sœur/ cousin/ cousine/ neveu/ nièce/ oncle/ tante/ Epoux/ Epouse/ petits fils/ petite fille/ compagne/ compagnon/ concubin/ concubine/ ex-époux/ ex-épouse/ ex-mari/ ex-femme/ ami/ amie/ etc...) (return the name of the relative name here not the relation),
        "Family Address" : (from delaration section) full address,
        "Relation with Deceased person" : (from delaration section) (fils/ fille/ père/ mère/ frère/ sœur/ cousin/ cousine/ neveu/ nièce/ oncle/ tante/ Epoux/ Epouse/ petits fils/ petite fille/ compagne/ compagnon/ concubin/ concubine/ ex-époux/ ex-épouse/ ex-mari/ ex-femme/ ami/ amie/ etc...)
    }
}
""")
